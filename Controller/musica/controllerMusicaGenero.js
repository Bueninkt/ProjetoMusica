...
const inserirMusicaGenero = async function(musicaGenero, contentType){
    try {
        ...
        {
                if (
                    musicaGenero.id_musica             == ''           || musicaGenero.id_musica     == undefined    || musicaGenero.id_  == null || isNaN(musicaGenero.id_musica)  || musicaGenero.id_musica <=0 ||
                ...
                )
                {
                    ...
                    if(resultgenero != false || typeof(resultgenero) == 'object'){
                        if(resultgenero.length > 0 ){
                            ...
                            let result = await musicaGeneroDAO.updateGenero(musicaGenero)
...
const buscarMusicaGenero = async function(id){
    try {
        if(id == '' || id == undefined || id == null || isNaN(id) || id <=0){
            ...
            let resultgenero = await filmeGeneroDAO.selectByIdMusicaGenero(parseInt(id))
